...
function nextSong() {
    ...
    console.log(currentSong.additionalAudioUrl)
    var newurl = "http://localhost/pandora/proxy.php?url="+encodeURIComponent(currentSong.additionalAudioUrl)+"&artist="+encodeURIComponent(currentSong.artistName)+"&song="+encodeURIComponent(currentSong.songName);

    mp3Player.setAttribute("src", newurl);
    mp3Player.play();
}
